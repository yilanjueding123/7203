...
#define PIC_WIDTH						1280//2560
#define PIC_HEIGH						720//1440//960
...
#define USE_IOKEY_NO					2// 1 //num of IO key
#define USE_ADKEY_NO					1  //num of ad key


#define VIDEO_KEY            	 	IO_H3 
#define CAPTURE_KEY            		IO_F5
#define PW_KEY_PRO					PWR_KEY0
...
#define C_USBDEVICE_PIN   				IO_G1//IO_G8//IO_C3
#define	SCCB_SCL      					IO_G8
#define	SCCB_SDA      					IO_G9
#define PW_EN							IO_F15//IO_F5
#define AD_DETECT_PIN					IO_F15
#define LED1							IO_F5//blue
#define LED2							IO_C10//red

#define CHARGE_PIN						IO_H5
#define AD_KEY_DETECT_PIN		ADC_LINE_0


#define CAPTURE_KEY_SAVE_VIDEO			1
#define PRODUCT_NUM                     7203
#define PRODUCT_DATA                    20170731
#define PROGRAM_VERSION_NUM             1	//136
...
#define DV_OUT_HIGH_LEVEL	0 //开机输出500ms 高电平
